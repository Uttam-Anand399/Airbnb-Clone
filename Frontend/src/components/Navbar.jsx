...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 z-50 bg-white w-full'>
        <div className='w-[100vw] min-h-[80px] border-b-[1px] border-[#d1d1d1] px-[40px] flex items-center justify-between '>
            <div><img src={logo} alt="" className='w-[130px]'/></div>
            <div className='w-[35%] relative hidden md:block'>
                <input type="text" 
                className='w-[100%] px-[30px] py-[10px] border-[2px] border-[#a1a0a0] outline-none overflow-auto rounded-[30px] text-[17px]  '
            ...
            <div className='flex items-center justify-center gap-[10px] relative '>
                ...
                >List your home</span>
                <button className='px-[20px] py-[20px] flex items-center justify-center gap-[5px] border-[1px] border-[#8d8c8c] rounded-[50px] hover:shadow-lg ' onClick={()=>setShowpopup((prev)=>!prev)}>
            ...
            {searchData?.length>0 &&<div className='w-[100vw] h-[450px] flex flex-col gap-[20px] absolute top-[50%] overflow-auto left-0 justify-start items-center '>
                    <div className='max-w-[500px] w-[100vw] h-[300px] overflow-hidden flex flex-col bg-[#fefdfd] p-[20px] rounded-lg border-[1px] border-[#a2a1a1] cursor-pointer '>
                        {
        ...
        <div className='w-[100vw] h-[85px] bg-white flex items-center justify-center gap-[40px] overflow-auto md:justify-center px-[15px]'>
