...
const ListingPage1 = () => {
  ...
  return (
    <div className='w-[100%] h-[100vh] bg-white flex items-center justify-center overflow-auto relative'>
        ...
        >
             <div className='w-[50px] h-[50px] bg-[red] cursor-pointer absolute top-[5%]  left-[20px] rounded-[50%] flex items-center justify-center 'onClick={()=>navigate("/")}><FaArrowLeft className='w-[25px] h-[25px] text-[white] ' /></div>
